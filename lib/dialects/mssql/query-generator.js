...
var QueryGenerator = {
  ...
  addLimitAndOffset: function(options, model) {
    ...
    if (options.limit || options.offset) {
      ...
      // FP-Hack: SQLServer 2008 does not support FETCH NEXT. In addition,
      // we only find individual instances, so we don't need OFFSET. We keep
      // it here in comments for historical purposes.
